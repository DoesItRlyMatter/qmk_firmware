...
#define NOLED_PORT_SCK PORTB // OK
#define NOLED_PIN_SCK PB1   // OK
#define NOLED_DDR_SCK DDRB  // OK
#define NOLED_DPIN_SCK DDB1  // OK

#define NOLED_PORT_MOSI PORTB // OK
#define NOLED_PIN_MOSI PB3   // OK
#define NOLED_DDR_MOSI DDRB  // OK
#define NOLED_DPIN_MOSI DDB3  // OK
